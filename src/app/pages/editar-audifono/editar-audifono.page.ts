...
export class ServiceBDService {
  ...
  private listadoAudifonos = new BehaviorSubject<any[]>([]);
  ...
  // Seleccionar todos los productos (puedes adaptarlo para audífonos si es necesario)
  ...
  // Devuelve un observable para los productos/audífonos
  fetchAudifonos() {
